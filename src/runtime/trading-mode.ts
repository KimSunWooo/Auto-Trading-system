...
function envInt(env: EnvMap, key: string, fallback: number): number {
...
export function liveTestCaps(env: EnvMap = process.env): LiveTestCaps {
  return {
    maxOrderKrw: envInt(env, "LIVE_TEST_MAX_ORDER_KRW", DEFAULT_LIVE_TEST_CAPS.maxOrderKrw),
    maxDailyBuyKrw: envInt(env, "LIVE_TEST_MAX_DAILY_ORDER_AMOUNT", DEFAULT_LIVE_TEST_CAPS.maxDailyBuyKrw),
    maxDailyOrders: envInt(env, "LIVE_TEST_MAX_DAILY_ORDER_COUNT", DEFAULT_LIVE_TEST_CAPS.maxDailyOrders),
    maxPositionKrw: envInt(env, "LIVE_TEST_MAX_POSITION_AMOUNT", DEFAULT_LIVE_TEST_CAPS.maxPositionKrw),
    maxPositionCount: envInt(env, "LIVE_TEST_MAX_POSITION_COUNT", DEFAULT_LIVE_TEST_CAPS.maxPositionCount),
  };
}
