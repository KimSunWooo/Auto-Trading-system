...
4. `ODNO`를 받은 뒤에만 로컬 장부에 체결 반영합니다.
5. 타임아웃/네트워크 오류는 `unknown` + 서킷 오픈입니다. 미체결로 단정하고 재시도하지 않습니다.
...
- KIS 모드는 정규장 외 주문을 내지 않습니다.
- 지정가는 접수를 체결로 장부에 넣지 않습니다.
