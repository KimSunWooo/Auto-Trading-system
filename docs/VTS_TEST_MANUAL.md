...
PAPER VTS 주문: 1회 1주, testRun당 신규 BUY 1건. 10,000원 금액 상한은 PAPER 자격에서 사용하지 않습니다.
REAL / 비-PAPER LIVE_TEST 서버 한도: 1건 10,000원, 하루 매수 30,000원, 하루 3건. 환경변수로 상향할 수 없습니다. PAPER 정책을 REAL에 적용하지 않습니다.
...
- PAPER 국내 테스트 종목은 현재 사용 중인 정상 종목(삼성전자 등) 1주 BUY. 금액 때문에 저가주로 바꾸지 않습니다.
...
**사전조건:** 공통. PAPER 1주 BUY. 금액 상한으로 차단하지 않습니다.
